 ...
 * The caller (browser SPA etc.) typically cannot read an HttpOnly refresh-token cookie directly,
 * so the server returns this hash out-of-band; both sides use the same hash.
 */

import { signP1363 } from "../keys/crypto.js";
import { toBase64Url } from "../keys/encoding.js";

export const POP_DOMAIN = "spawnery/refresh-pop/v1";
