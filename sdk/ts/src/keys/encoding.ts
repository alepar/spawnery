/**
 * Encoding utilities shared by the signing engine and keystore layer.
 *
 ...
 * This function is a load-bearing cross-language interop primitive (ported from
 * web/src/keys/encoding.ts, verified there against Go golden vectors).
 */
