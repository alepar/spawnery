...
func TestSchemaDriftSqlite(t *testing.T) {
	...
	check("spawns", "id", "owner_id", "name", "app_id", "app_version", "app_ref", "pinned", "model", "image", "runnable_id", "mode", "status", "recovered", "created_at", "last_used_at", "suspended_at", "deleted_at", "status_seq", "claim_holder", "claim_lease_id", "claim_deadline", "fork_capture_deadline", "parent_spawn_id", "forked_at", "github_credential_status")
	...
	check("profile_entries", "profile_id", "entry_id", "kind", "name", "source_kind", "catalog_id", "custom_inline", "targets", "mcp_secret_refs", "bundle_id", "version_id", "bundle_overrides", "disabled")
