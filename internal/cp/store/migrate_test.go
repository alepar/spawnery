...
func TestMigrationsCreateAllTables(t *testing.T) {
	...
	sort.Strings(names)
	want := []string{"agent_image_binaries", "agent_images", "app_version_mounts", "app_versions", "apps", "migration_transfer_sets", "owners", "profile_entries", "profile_secrets", "profiles", "spawn_artifacts", "spawn_containers", "spawn_mounts", "spawns"}
