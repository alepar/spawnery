...
type AgentSpec struct {
	Image string
	// Cmd is the argument vector passed to the image entrypoint; nil uses the image default. Docker
	// maps it to Config.Cmd and CRI maps it to ContainerConfig.Args, preserving identical dispatcher
